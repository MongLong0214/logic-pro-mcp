...
@Test func testServerCatalogStartupBannerUsesProvidedChannelCount() {
    ...
    #expect(banner == "Starting logic-pro-mcp v3.11.0 — 10 tools, \(ResourceProvider.resources.count) resources, 7 channels")
}
...
@Test func testLogicProServerCompositionSnapshotMatchesExpectedOrder() async {
    ...
    #expect(snapshot.startupBanner == "Starting logic-pro-mcp v3.11.0 — 10 tools, \(ResourceProvider.resources.count) resources, 7 channels")
}
