...
///
/// A census that reports what is NOT there is only as good as the subtrees it entered, and a failed
/// child read contributes nothing while looking exactly like an element with no children. Measured
/// 2026-09-08 in the sibling attribute census: twenty elements answer kAXErrorFailure to this call,
/// stably. `noValue` and `attributeUnsupported` are real answers and are not counted.
