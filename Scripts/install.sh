...
reject_protected_system_path(){ local label="$1" path="$2"; case "$path" in /|/System|/System/*|/etc|/etc/*|/private/etc|/private/etc/*|/tmp|/tmp/*|/private/tmp|/private/tmp/*|/private/var/db|/private/var/db/*|/bin|/bin/*|/sbin|/sbin/*|/usr/bin|/usr/bin/*|/usr/sbin|/usr/sbin/*) fail_path_validation "$label must not target a protected system path: $path" ;; esac; }
