...
VERSION="${LOGIC_PRO_MCP_VERSION:-v3.17.0}"
    ...
    while IFS= read -r line; do
        ...
        case "$path" in
            /*|../*|*/../*|*/..|..)
                ...
                ;;
            LogicProMCP|docs|docs/|docs/SETUP.md|Scripts|Scripts/|Scripts/install-keycmds.sh|Scripts/uninstall-keycmds.sh|Scripts/keycmd-preset.plist|Scripts/LogicProMCP-Scripter.js|Scripts/logic_bounce.py|Scripts/logic_bounce_ui.py|Scripts/logic_ui_jxa.py|Scripts/logic_input_source.py|Scripts/logic_variants.py|Scripts/logic_ui_labels.py)
                ;;
            *)
...
if fetch_release_archive "$TMP_ARCHIVE"; then
    ...
    EXTRACTED_UI_LABELS="$TMP_DIR/Scripts/logic_ui_labels.py"
    ...
    validate_optional_extracted_asset_file "$EXTRACTED_UI_LABELS"
