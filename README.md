...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/stable-v3.14.0-blue.svg?style=flat-square" />
</p>
...
| Release state | Published stable [v3.14.0](https://github.com/MongLong0214/logic-pro-mcp/releases/tag/v3.14.0); previous stable `v3.13.0` remains available for pinned installs (note: v3.11.0 Homebrew bounce/export is broken by a packaging omission fixed in v3.12.0 — #427) |
...
- **Release honesty**: published `v3.14.0` is the current stable install line, and README claims stay tied to shipped artifacts, release-tree tests, or explicitly linked live evidence.
...
```bash
curl -fsSL https://raw.githubusercontent.com/MongLong0214/logic-pro-mcp/v3.14.0/Scripts/install.sh -o install.sh
...
bash <(curl -fsSL https://raw.githubusercontent.com/MongLong0214/logic-pro-mcp/v3.14.0/Scripts/install.sh)
```
