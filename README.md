...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-3.0.2-blue.svg?style=flat-square" />
</p>
...
**v3.0.2** (2026-04-19) — Production-ready, adhoc-signed pre-release.
...
- **759 unit + integration tests passing** on the v3.0.2 branch (`swift test`, no skips)
