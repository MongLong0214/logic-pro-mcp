...
enum AXLocalePolicy {
    ...
    static let controlBarGroupLabel = LabelSet(
        ...
        variants: ["컨트롤 막대", "コントロールバー", "Steuerungsleiste", "Barra de controles", "Barre des commandes", "Barra di controllo", "控制条", "控制列"],
