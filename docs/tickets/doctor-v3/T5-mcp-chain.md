...
| 6 | `test_t5_n5_relative_command_excluded` | Unit | AC-3 / E15 | relative registered command ⇒ excluded; `.pass` (or non-warn), evidence `reason=="relative_command"`; no false-warn |
